  ...
  return (
    <div className="container mx-auto p-4 max-w-4xl">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">다양한 AI 응답 시나리오를 테스트해볼 수 있습니다.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <Card>
          ...
          <CardContent className="space-y-3">
            <Button onClick={() => startDemo("loading")} className="w-full" variant="outline">
              로딩 상태만 보기
            </Button>
            <Button onClick={() => startDemo("technical")} className="w-full" variant="outline">
              기술 문의 응답
            </Button>
            <Button onClick={() => startDemo("billing")} className="w-full" variant="outline">
              결제 문의 응답
            </Button>
            <Button onClick={() => startDemo("general")} className="w-full" variant="outline">
              일반 문의 응답
            </Button>
            <Button onClick={() => setCurrentDemo("none")} className="w-full" variant="destructive">
              초기화
            </Button>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <ul className="space-y-2 text-sm">
              <li>
                • <strong>로딩 애니메이션</strong>: 3가지 스타일의 로딩 표시
              </li>
              <li>
                • <strong>타이핑 효과</strong>: 실시간으로 텍스트가 나타남
              </li>
              <li>
                • <strong>마크다운 지원</strong>: 제목, 목록, 코드 블록 등
              </li>
              <li>
                • <strong>별점 평가</strong>: 1-5점 만족도 평가
              </li>
              <li>
                • <strong>에스컬레이션</strong>: 사람과 연결 기능
              </li>
              <li>
                • <strong>반응형 디자인</strong>: 모바일/데스크톱 대응
              </li>
            </ul>
          </CardContent>
        </Card>
