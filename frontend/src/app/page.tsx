        ...
        <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
          ...
          <div className="flex gap-6 justify-center">
            <Link href="/inquiry">
              <Button
                size="lg"
                className="flex items-center gap-3 bg-orange-600 hover:bg-orange-700 text-white px-12 py-6 text-xl rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300"
              >
      ...
      <section className="min-h-screen flex items-center bg-gray-50 py-20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">헌터스 고객님들을 위한 편리하고 빠른 지원 서비스를 제공합니다</p>
          </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            <div className="text-center group">
              <div className="w-24 h-24 bg-orange-600 rounded-3xl flex items-center justify-center mx-auto mb-8 group-hover:scale-110 transition-transform duration-300 shadow-xl">
      ...
      <section className="min-h-screen flex items-center bg-gray-900 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <Link href="/inquiry">
            <Button
              size="lg"
              className="bg-orange-600 hover:bg-orange-700 text-white px-16 py-8 text-2xl rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-300"
            >
              지금 문의하기
            </Button>
          </Link>
