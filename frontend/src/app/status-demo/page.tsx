  ...
  return (
    <div className="container mx-auto p-4 max-w-6xl">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">다양한 문의 상태와 카운트다운 타이머를 테스트해볼 수 있습니다.</p>
      </div>
            ...
            {demoScenarios.map((scenario) => (
              ...
              >
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">문의 ID: {scenario.inquiryId}</p>
                </CardContent>
              </Card>
            ))}
          </div>
          ...
          {selectedDemo ? (
                  ...
                  <>
                    <Card>
                      ...
                      <CardContent>
                        ...
                        <p className="text-sm text-muted-foreground mb-4">카테고리: 기술 문의</p>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex gap-4">
                            <div className="flex flex-col items-center">
                              ...
                              {scenario.status !== "pending" && <div className="w-px h-8 bg-gray-200 mt-2"></div>}
                            </div>
                            <div className="flex-1 pb-4">
                              <h4 className="font-medium">AI 자동 응답</h4>
                              <p className="text-sm text-muted-foreground mb-1">AI가 초기 답변을 제공했습니다.</p>
                          ...
                          {scenario.status !== "pending" && (
                            <div className="flex gap-4">
                              <div className="flex flex-col items-center">
                                ...
                                {scenario.status !== "completed" && <div className="w-px h-8 bg-gray-200 mt-2"></div>}
                              </div>
                              <div className="flex-1 pb-4">
            ...
            <Card>
              <CardContent className="text-center py-16">
                ...
                <p className="text-muted-foreground">왼쪽에서 데모 시나리오를 선택해주세요</p>
              </CardContent>
            </Card>
          )}
        </div>
