        ...
        <Card>
          <CardContent className="text-center py-16">
            ...
            <p className="text-muted-foreground mb-4">
              요청하신 문의 ID({inquiryId})를 찾을 수 없습니다.
            </p>
            <Link href="/inquiry">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-sm text-muted-foreground mb-4">
                카테고리: {inquiry.category === 'technical' ? '기술 문의' : 
                         inquiry.category === 'billing' ? '결제 문의' : '일반 문의'}
              </p>
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="text-sm space-y-2">
              <p><strong>대기중:</strong> 문의가 접수되어 처리를 기다리고 있습니다.</p>
              <p><strong>처리중:</strong> 담당자가 문의를 검토하고 있습니다.</p>
              <p><strong>완료:</strong> 답변이 완료되었습니다.</p>
              <hr className="my-3" />
              <p className="text-muted-foreground">
                평균 응답 시간은 2-4시간입니다. 긴급한 문의는 우선 처리됩니다.
              </p>
            </CardContent>
          </Card>
        </div>
